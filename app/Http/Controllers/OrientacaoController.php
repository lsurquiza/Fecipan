...
class OrientacaoController extends Controller {
    ...
    public function __construct()
    {
        ...
        $this->middleware(function($request, $next){
			...
			$conteudo = Auth::user()->perfil->conteudos->where("rota", "/orientacao")->first();
	...
	public function formCreate($trabalho_id){
		...
		if ($this->permissoes->inserir){
			return view('orientacao.formCreate')->with(["orientadores"=>$orientadores, "trabalho"=>$trabalho, "tem_orientador"=>$tem_orientador]);
		}else{
	...
	public function create(Request $request){
		...
		return redirect("/trabalho/orientadores/{$params['trabalho_id']}");
	}

	public function delete($trabalho_id, $orientador_id){
