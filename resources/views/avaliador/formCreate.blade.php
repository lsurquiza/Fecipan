...
<div class="panel panel-default">
	...
	<div class="panel-body">
		<form class="form-horizontal" role="form" method="POST" action="{{ url('/avaliador/create') }}">
			{{ csrf_field() }}

			<div class="form-group{{ $errors->has('instituicao') ? ' has-error' : '' }}">
				<label for="instituicao_id" class="col-sm-4 col-md-3 control-label">Instituição</label>

				<div class="col-sm-8 col-md-6">
					<select id="instituicao_id" name="instituicao_id" data-placeholder="Escolha a instituição de ensino..." class="chosen-select form-control input-md">
						<option value=""></option>
			...
			<div class="form-group{{ $errors->has('area') ? ' has-error' : '' }}">
				<label for="area" class="col-sm-4 col-md-3 control-label">Área</label>

				<div class="col-sm-8 col-md-6">
					<input id="area" type="text" class="form-control" name="area" value="{{ old('area') }}" autofocus>
			...
			<div class="form-group">
				<div class="col-md-6 col-sm-offset-4 col-md-offset-3">
					...
					<a href="\pessoa\avaliadores" class="btn btn-danger">
						Cancelar
					</a>
				</div>
			</div>
