...
<div class="panel panel-default">
	...
	<div class="panel-body">
		<form class="form-horizontal" action="/area/create" method="POST">
			<input type="hidden" name="_token" value="{{{ csrf_token() }}}" />
			<fieldset>
			<div class="form-group">
			  <label class="col-md-3 col-sm-4 control-label" for="sigla">Sigla</label>  
			  <div class="col-md-3 col-sm-4">
				<input id="sigla" name="sigla" type="text" placeholder="Digite a sigla da área" class="form-control input-md">
			...
			<div class="form-group">
			  ...
			  <div class="col-md-6 col-sm-8">
				<input id="area" name="area" type="text" placeholder="Digite a descrição da área" class="form-control input-md">
				  <!-- DIV PARA MOSTRAR OS ERROS -->
				 @if(count($errors)>0)
					<div class="text-danger">			
