...
<div class="panel panel-default">
	...
	<form class="form-horizontal" action="/evento/create" method="POST">
		...
		<div class="form-group">
		  ...
		  <div class="col-sm-8 col-md-6">
		  	<input id="titulo" name="titulo" type="text" placeholder="Título do evento" class="form-control input-md">
		  	@if(count($errors)>0)
		...
		<div class="form-group">
		  ...
		  <div class="col-sm-3 col-md-2">
		  	<input id="ano" name="ano" type="number" placeholder="Ano do evento" class="form-control input-md">
		  	@if(count($errors)>0)
		  	 	<div class="text-danger">			
		...
		<div class="form-group">
		  ...
		  <div class="col-sm-3 col-md-2">
		  	<input id="semestre" name="semestre" type="text" placeholder="Semestre do evento" class="form-control input-md">
		  	@if(count($errors)>0)
		  	 	<div class="text-danger">			
		...
		<div class="form-group">
		  ...
		  <div class="col-sm-8 col-md-6">
		  	<input id="tema" name="tema" type="text" placeholder="Digite o tema do evento" class="form-control input-md">
		  	@if(count($errors)>0)
		  	 	<div class="text-danger">			
		...
		<div class="form-group">
		  ...
		  <div class="col-sm-8 col-md-6">
		  	<input id="cidade" name="cidade" type="text" placeholder="Digite a cidade do evento" class="form-control input-md">
		  	@if(count($errors)>0)
		  	 	<div class="text-danger">			
		...
		<div class="form-group">
		  ...
		  <div class="col-sm-4 col-md-3">
		  	<input id="data_inicio" name="data_inicio" type="date" placeholder="Digite a data de ínicio do evento" class="form-control input-md">
		  	@if(count($errors)>0)
		  	 	<div class="text-danger">			
		...
		<div class="form-group">
		  ...
		  <div class="col-sm-4 col-md-3">
		  	<input id="data_fim" name="data_fim" type="date" placeholder="Digite a data do fim do evento" class="form-control input-md">
		  	@if(count($errors)>0)
		  	 	<div class="text-danger">			
