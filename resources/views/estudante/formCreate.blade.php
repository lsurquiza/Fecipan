...
<div class="panel panel-default">
	...
	<div class="panel-body">
		<form class="form-horizontal" role="form" method="POST" action="{{ url('/estudante/create') }}">
			{{ csrf_field() }}
			...
			<div class="form-group{{ $errors->has('categoria') ? ' has-error' : '' }}">
				<label for="categoria_id" class="col-sm-4 col-md-3 control-label">Categoria</label>
